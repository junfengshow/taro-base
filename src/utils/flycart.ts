...
/* 参数校验 */
function Validityparameter(startPoint, endPoint, point) {
  let isOkey = true;
...
function flycart(startPoint: any, endPoint: any, point: number, h: number = 0, hclientX?: number) {
  /* 
  ...
  */
  ...
  /* 参数验证 */
  if (!Validityparameter(startPoint, endPoint, point)) {
    return []
  }
